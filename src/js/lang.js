...
const homeTexts = {
  ...
  'my-services-title-4': {
    ua: 'Процес підбору офісу (Remote)',
    ru: 'Процесс подбора офиса (Remote)',
    pl: 'Proces wyboru biura (Remote)',
    en: 'Office selection process (Remote)',
  },
  'my-services-title-41': {
    ua: '1. Консультація та брифінг',
    ru: '1. Консультация и брифинг',
    pl: '1. Konsultacje i briefingi',
    en: '1. Consultation and briefing',
  },
  'my-services-title-42': {
    ua: 'Я проводжу онлайн-зустріч, щоб зрозуміти ваші бізнес-цілі та вимоги до офісного простору',
    ru: 'Я провожу онлайн-встречу, чтобы понять ваши бизнес-цели и требования к офисному пространству',
    pl: 'Przeprowadzam spotkanie online, aby zrozumieć Twoje cele biznesowe i wymagania dotyczące powierzchni biurowej',
    en: 'I conduct an online meeting to understand your business goals and office space requirements',
  },
  'my-services-title-43': {
    ua: '2. Перелік офісних приміщень',
    ru: '2. Список офисных помещений',
    pl: '2. Lista powierzchni biurowych',
    en: '2. List of office spaces',
  },
  'my-services-title-44': {
    ua: 'Ви отримуєте перелік доступних офісних приміщень, які відповідають вашим критеріям',
    ru: 'Вы получаете список доступных офисных помещений, которые отвечают вашим критериям',
    pl: 'Otrzymasz listę dostępnych powierzchni biurowych spełniających Twoje kryteria',
    en: 'You receive a list of available office spaces that meet your criteria',
  },
  ...
  'my-services-title-46': {
    ua: 'Я організую Live-трансляцію, де ви можете в реальному часі просити показати деталі: від виду з вікна до стану інженерних комунікацій',
    ru: 'Я организую Live-трансляцию, где вы можете в реальном времени просить показать детали: от вида из окна до состояния инженерных коммуникаций',
    pl: 'Zorganizuję transmisję na żywo, gdzie będzie można poprosić o pokazanie szczegółów na bieżąco: od widoku z okna po stan mediów',
    en: 'I will organize a live broadcast where you can ask to show details in real time: from the view from the window to the state of utilities',
  },
  'my-services-title-47': {
    ua: '4. Технічна підтримка',
    ru: '4. Техническая поддержка',
    pl: '4. Wsparcie techniczne',
    en: '4. Technical support',
  },
  'my-services-title-48': {
    ua: 'Ви отримуєте точний розрахунок робочих місць, зон колаборації та ергономіки від наших архітекторів',
    ru: 'Вы получаете точный расчет рабочих мест, зон коллаборации и эргономики наших архитекторов',
    pl: 'Nasi architekci wykonają dla Ciebie dokładne obliczenia stanowisk pracy, stref współpracy i ergonomii',
    en: 'You receive an accurate calculation of workplaces, collaboration areas and ergonomics from our architects',
  },
  ...
  'my-services-title-50': {
    ua: 'Завдяки моїм налагодженим бізнес-відносинам з власниками приміщень я можу добитися найкращих орендних умов для вашого бізнесу',
    ru: 'Благодаря моим налаженным бизнес-отношениям с владельцами помещений я могу добиться наилучших арендных условий для вашего бизнеса',
    pl: 'Dzięki moim ugruntowanym relacjom biznesowym z właścicielami nieruchomości, mogę wynegocjować dla Twojej firmy najlepsze warunki wynajmu',
    en: 'Thanks to my established business relationships with property owners, I can achieve the best rental conditions for your business',
  },
  ...
  'my-services-title-52': {
    ua: 'Моя підтримка не завершується підписанням угоди. Я супроводжую вас протягом усього терміну оренди у вирішенні технічних та юридичних запитів',
    ru: 'Моя поддержка не завершается подписанием соглашения. Я сопровождаю вас в течение всего срока аренды в решении технических и юридических запросов',
    pl: 'Moje wsparcie nie kończy się wraz z podpisaniem umowy. Towarzyszę Państwu przez cały okres wynajmu w rozwiązywaniu problemów technicznych i prawnych',
    en: 'My support does not end with the signing of the agreement. I accompany you throughout the rental period in resolving technical and legal queries',
  },
  about_title3: {
